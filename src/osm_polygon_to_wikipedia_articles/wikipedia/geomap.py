"""Back-compat shim. The real module now lives at
    osm_polygon_to_wikipedia_articles.wikipedia.visualization.geomap
...
.wikipedia.geomap import ...`` keep working without modification.
"""
from __future__ import annotations

from .visualization.geomap import *  # noqa: F401, F403
