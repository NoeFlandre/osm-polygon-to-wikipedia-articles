"""Back-compat shim. The real module now lives at
    osm_polygon_to_wikipedia_articles.wikipedia.visualization.map
...
.wikipedia.map import ...`` keep working without modification.
"""
from __future__ import annotations

from .visualization.map import *  # noqa: F401, F403
